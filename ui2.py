...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.postdata_textEdit = QtGui.QTextEdit(self.groupBox_3)
        self.postdata_textEdit.setMinimumSize(QtCore.QSize(0, 0))
        self.postdata_textEdit.setObjectName(_fromUtf8("postdata_textEdit"))
        self.verticalLayout_2.addWidget(self.postdata_textEdit)
        self.horizontalLayout_2 = QtGui.QHBoxLayout()
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.username_mark_btn = QtGui.QPushButton(self.groupBox_3)
        self.username_mark_btn.setObjectName(_fromUtf8("username_mark_btn"))
        self.horizontalLayout_2.addWidget(self.username_mark_btn)
        self.pwd_mark_btn = QtGui.QPushButton(self.groupBox_3)
        self.pwd_mark_btn.setObjectName(_fromUtf8("pwd_mark_btn"))
        self.horizontalLayout_2.addWidget(self.pwd_mark_btn)
        self.remove_mark_btn = QtGui.QPushButton(self.groupBox_3)
        self.remove_mark_btn.setObjectName(_fromUtf8("remove_mark_btn"))
        self.horizontalLayout_2.addWidget(self.remove_mark_btn)
        self.save_mark_btn = QtGui.QPushButton(self.groupBox_3)
        self.save_mark_btn.setObjectName(_fromUtf8("save_mark_btn"))
        self.horizontalLayout_2.addWidget(self.save_mark_btn)
        ...
        self.pwd_file_path_label.setObjectName(_fromUtf8("pwd_file_path_label"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "抓包保存", None))
        self.groupBox_3.setTitle(_translate("MainWindow", "抓包修改", None))
        self.username_mark_btn.setText(_translate("MainWindow", "用户名标记", None))
        self.pwd_mark_btn.setText(_translate("MainWindow", "密码标记", None))
        self.remove_mark_btn.setText(_translate("MainWindow", "删除标记", None))
        self.save_mark_btn.setText(_translate("MainWindow", "保存标记", None))
        ...
        self.usrname_file_path_label.setText(_translate("MainWindow", "选取用户名文件", None))
        self.pwd_file_path_label.setText(_translate("MainWindow", "选取密码文件", None))
